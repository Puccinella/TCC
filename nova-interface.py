...
ctk.set_appearance_mode("#1F2937")
...
#criação dos frames
frame1 = ctk.CTkFrame(app, border_width=2, border_color="white", fg_color="transparent")
frame1.grid(row=0, column=0, padx=20, pady=20, sticky="nsew")

frame2 = ctk.CTkFrame(app, border_width=2, border_color="red", fg_color="#9CA3AF")
frame2.grid(row=0, column=1, padx=20, pady=20, sticky="nsew")

frame3 = ctk.CTkFrame(app, border_width=2, border_color="blue", fg_color="transparent")
...
frame_texto = ctk.CTkFrame(frame2, border_width=2, border_color="white", fg_color="transparent")
...
label = ctk.CTkLabel(frame_texto, text="Bem vindo(a)!", fg_color="transparent", font=("arial", 20), border_width=2, border_color="white")
label.grid(row=0, column=0, padx=10, pady=10, sticky="ew")


botaocadastro = ctk.CTkButton(frame_texto, text="Cadastrar", command=cadastro)
botaocadastro.grid(row=1, column=0, padx=20, pady=10)


botao_verificacao = ctk.CTkButton(frame_texto, text="Verificação", command=verificacao)
botao_verificacao.grid(row=2, column=0, padx=20, pady=10)
